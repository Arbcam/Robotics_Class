...
3. QuantumLeaps State Machine Framework - This is the tool for developing with the state machine framework, please download both this: https://sourceforge.net/projects/qpc/files/QP-C/5.8.2/qpc_5.8.2.exe/download, and this: https://sourceforge.net/projects/qpc/files/QP-C/5.8.2/qpc_5.8.2.exe/download
